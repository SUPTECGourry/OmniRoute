...
| `XAI_OAUTH_CLIENT_ID`             | xAI Grok OAuth          | Optional override for the public desktop OAuth client ID used by `xai-oauth`. OmniRoute embeds the public default via `open-sse/utils/publicCreds.ts`; leave unset unless overriding public client metadata.                                    |
